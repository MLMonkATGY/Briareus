...
class ZipToTransfer implements iRepeatJobBase{
    ...
    public triggerFC = async(payload:Array<Array<string>>)=>{
        let count = 0;
        let allP = []
        // let totalCmd = ""
        let commands = []
        ...
        const base = "https://5138646860170696.ap-southeast-3.fc.aliyuncs.com/2016-08-15/proxy/httpWorker/zipDir/"
